...
class MediaFileAdapter(var clickListeners: FileClickListeners?=null) :
        RecyclerView.Adapter<MediaFileAdapter.FileViewHolder>() {
    ...
    override fun onBindViewHolder(holder: FileViewHolder, position: Int) {
        ...
        holder.date.text = fileList[position].dateModified.toString()
